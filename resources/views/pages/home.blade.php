...
@section('content')
            ...
            <div id="controls-carousel" class="relative max-w-screen-xl mx-auto h-vh" data-carousel="slide">
                ...
                <div class="relative overflow-hidden h-96 content-center">
                    @foreach ($banners as $banner)
                        <div class="hidden duration-1000 px-10 lg:px-36 w-full ease-in-out flex items-center"
                            data-carousel-item>
                            <div class="w-full lg:w-1/2 text-left text-gray-700 dark:text-gray-400">
                                <h1
                                    class="mb-4 text-4xl md:text-4xl lg:text-5xl font-extrabold leading-none tracking-tight text-gray-900 dark:text-white">
                                    {{ $banner->judul }}
                                </h1>
                                <p class="text-md md:text-lg lg:text-xl mb-4 text-black dark:text-white">
                                    {{ $banner->subjudul }}</p>
                                <a href="{{ $banner->link }}"
                                    class="text-white bg-gradient-to-r from-cyan-400 via-cyan-500 to-cyan-600 
                                    hover:bg-gradient-to-br focus:ring-4 focus:outline-none 
                                    focus:ring-cyan-300 dark:focus:ring-cyan-800 shadow-lg shadow-cyan-500/50 dark:shadow-lg dark:shadow-cyan-800/80 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2">
                                    {{ $banner->cta }}
                                </a>
                            </div>
                ...
                <button type="button"
                    ...
                    data-carousel-prev>
                    <span
                        class="inline-flex items-center justify-center w-4 h-4 lg:w-10 lg:h-10 rounded-full bg-gray-800/70 dark:bg-white/70 group-hover:bg-gray-800 dark:group-hover:bg-white group-focus:ring-4 group-focus:ring-gray-800 dark:group-focus:ring-white group-focus:outline-none">
                        <svg class="w-2 lg:w-4 h-2 lg:h-4 text-white dark:text-gray-800 rtl:rotate-180" aria-hidden="true"
        ...
        <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-12">
            ...
            <div class="flex flex-wrap">
                ...
                <div class="w-full lg:w-1/2">
                    <h2 class="text-3xl font-bold text-gray-900 dark:text-white mb-4">Sasaran Strategis Kami</h2>
                    <ol class="space-y-4 text-sm sm:lg-text-xs lg:text-md list-decimal list-inside">
                        <li class="font-bold text-dark-900 dark:text-white">
                            Meningkatnya Partisipasi Pemuda Dalam Kegiatan Ekonomi Mandiri
                            <ul class="ps-5 mt-1 font-normal list-disc list-inside">
                                <li class="text-gray-700 dark:text-gray-300">Meningkatkan peran serta pemuda dalam
                                    kewirausahaan pemuda</li>
                            </ul>
                        </li>
                        <li class="font-bold text-dark-900 dark:text-white">
                            Meningkatnya Peran Serta Pemuda Dalam Organisasi Kepemudaan dan Sosial Kemasyarakatan
                            <ul class="ps-5 mt-1 font-normal list-disc list-inside">
                                <li class="text-gray-700 dark:text-gray-300">Meningkatkan partisipasi pemuda dalam kegiatan
                                    organisasi kepemudaan</li>
                                <li class="text-gray-700 dark:text-gray-300">Meningkatkan partisipasi pemuda untuk
                                    berpendapat dalam rapat kepemudaan</li>
                            </ul>
                        </li>
                        <li class="font-bold text-dark-900 dark:text-white">
                            Meningkatnya Masyarakat Dalam Melaksanakan Kegiatan Olahraga
                            <ul class="ps-5 mt-1 font-normal list-disc list-inside">
                                <li class="text-gray-700 dark:text-gray-300">Meningkatkan minat masyarakat untuk
                                    berolahraga melalui kegiatan keolahragaan</li>
                            </ul>
                        </li>
                        <li class="font-bold text-dark-900 dark:text-white">
                            Meningkatnya Peran Serta Pemuda Dalam Organisasi Kepemudaan dan Sosial Kemasyarakatan
                            <ul class="ps-5 mt-1 font-normal list-disc list-inside">
                                <li class="text-gray-700 dark:text-gray-300">Meningkatkan kualitas daya saing atlet dan
                                    tenaga keolahragaan lainnya</li>
                                <li class="text-gray-700 dark:text-gray-300">Meningkatkan standarisasi sarana dan prasarana
                                    olahraga</li>
                                <li class="text-gray-700 dark:text-gray-300">Pemberian penghargaan terhadap atlet dan
                                    organisasi olahraga berprestasi</li>
                            </ul>
                        </li>
                    </ol>
                </div>
    ...
    <section class="bg-white dark:bg-gray-900 py-8">
        <div class="px-4 py-4 lg:px-6 mx-auto my-12 lg:my-20 max-w-screen-xl bg-gray-800 lg:rounded-xl">
            <hr class="w-48 h-1 mx-auto bg-gray-100 border-0 rounded dark:bg-gray-700">
            <div class="mx-auto max-w-screen-sm text-center lg:mb-16 mb-8">
                <h2 class="mb-4 text-3xl lg:text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">
                    <div class="flex justify-center mb-4">
                        <div class="w-24 h-24 rounded-full bg-blue-500 flex items-center justify-center mt-2 md:mt-4">
            ...
            <ol class="relative dark:border-gray-700">
                @forelse ($events as $event)
                    <li class="mb-10 ms-4">
                        ...
                        <time
                            class="mb-1 text-sm font-normal leading-none text-gray-400 dark:text-gray-500">{{ $event->scheduled_for->diffForHumans() }}</time>
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white">{{ $event->title }}
                        </h3>
                        <p class="mb-4 text-base font-normal text-gray-500 dark:text-gray-400">{{ $event->body }}</p>
                    </li>
                @empty
                    <div class="w-full col-span-5 text-center text-gray-900 dark:text-white">
                        <h5 class="text-md lg:text-xl font-semibold">Stay Tune! - Something good might happen soon -</h5>
                    </div>
                @endforelse
            </ol>
        </div>
    ...
    <section class="bg-white dark:bg-gray-900">
        ...
        <div
            class="mx-auto grid max-w-screen-xl grid-cols-3 gap-8 text-gray-500 dark:text-gray-400 sm:gap-12 lg:grid-cols-3 px-4 py-8 lg:py-12 items-center justify-center place-items-center">
            <a href="#"
                class="flex items-center md:justify-center text-lg dark:text-gray-200 hover:text-blue-500 dark:hover:text-blue-500">
                <svg class="w-[48px] h-[48px]" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24"
            ...
            <a href="#"
                class="flex items-center md:justify-center text-lg text-gray-700 dark:text-gray-200 hover:text-pink-500 dark:hover:text-pink-500">
                <svg class="w-[48px] h-[48px]" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24"
            ...
            <a href="#"
                class="flex items-center md:justify-center text-lg text-gray-700 dark:text-gray-200 hover:text-red-500 dark:hover:text-red-500">
                <svg class="w-[48px] h-[48px]" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24"
                    height="24" fill="currentColor" viewBox="0 0 24 24">
                    <path fill-rule="evenodd"
    ...
    <!-- Information -->
    <section class="bg-white dark:bg-gray-900 py-8">
        <div class="px-4 py-4 lg:px-6 mx-auto my12 lg:my-20 max-w-screen-xl bg-gray-800 lg:rounded-xl">
            <hr class="w-48 h-1 mx-auto bg-gray-100 border-0 rounded dark:bg-gray-700">
            <div class="mx-auto max-w-screen-sm text-center lg:mb-16 mb-8">
                <h2 class="mb-4 text-3xl lg:text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">
                    <div class="flex justify-center mb-4">
                    ...
                    <span
                        class="underline underline-offset-3 decoration-8 decoration-blue-400 dark:decoration-blue-600">Pengumuman</span>
                </h2>
                <p class="font-light text-gray-500 sm:text-xl dark:text-gray-400">Informasi penting tentang kepemudaan dan
                    keolahragaan kami sajikan disini</p>
            </div>
            <div class="flex flex-col md:grid md:grid-cols-4 mx-auto max-w-screen-xl gap-8">
                <div class="w-full">
                    @forelse ($pengumumans as $pengumuman)
                        <div
                            class="bg-gray-100 dark:bg-gray-800 dark:hover:bg-gray-600 hover:bg-gray-200 rounded-lg shadow-md p-6">
                            ...
                            <h3 class="text-lg font-semibold text-gray-900 dark:text-white mt-2"><a
                                    href="{{ route('filamentblog.post.show', ['post' => $pengumuman->slug]) }}">{{ $pengumuman->title }}</a>
                            </h3>
                            <p class="text-gray-500 dark:text-gray-400 mt-2">{{ Str::limit(strip_tags($pengumuman->body), 100) }}
                            </p>
                            <span
                                class="text-sm text-gray-600 dark:text-gray-200 py-2 block">{{ $pengumuman->published_at->diffForHumans() }}</span>
                            <a href="{{ route('filamentblog.post.show', ['post' => $pengumuman->slug]) }}"
                    ...
                    @empty
                        <div class="w-full col-span-5 text-center text-gray-900 dark:text-white">
                            <h5 class="text-md lg:text-xl font-semibold">Stay Tune! - Something good might happen soon -
                            </h5>
                        </div>
                    @endforelse
                </div>
                    ...
                    @if ($index == 0)
                        <div
                            ...
                            <img class="w-full h-48 object-cover rounded-t-lg"
                                src="{{ asset("storage/$p->cover_photo_path") }}" alt="Article Image">
                            <div class="p-6">
                                ...
                                <h2 class="text-2xl font-bold text-gray-900 dark:text-white mt-2"><a
                                        href="{{ route('filamentblog.post.show', ['post' => $p->slug]) }}">{{ $p->title }}</a>
                                </h2>
                                ...
                                <p class="text-gray-500 dark:text-gray-400 mt-4">
                                    {{ Str::limit(strip_tags($p->body), 300) }}</p>
                ...
                @foreach ($posts as $index => $p)
                    @if ($index > 0)
                        <div
                            ...
                            <p class="text-gray-500 dark:text-gray-400 mt-2">{{ Str::limit(strip_tags($p->body), 100) }}
                            </p>
                            <span
