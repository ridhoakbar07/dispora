<x-blog-layout>
    <section class="pb-16">
        <div class="container mx-auto">
            <nav aria-label="Breadcrumb" class="mb-4 lg:mb-12 mt-6 flex gap-x-2 text-sm font-semibold">
                <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                    ...
                    <li aria-current="page">
                        <div class="flex items-center">
                            ...
                            <span
                                class="ms-1 text-sm font-medium md:ms-2 text-gray-700 dark:text-gray-400 ">{{ $post->title }}</span>
                        </div>
                    </li>
                </ol>
            </nav>
                    ...
                    <div class="space-y-10">
                        <div>
                            <div class="flex flex-col justify-end">
                                ...
                                <div class="mb-6">
                                    <h1 class="mb-6 text-4xl font-semibold dark:text-white">
                                        {{ $post->title }}
                                    </h1>
                                    <p class="text-gray-700 dark:text-gray-400 ">{{ $post->sub_title }}</p>
                                    <div class="mt-2">
                                        ...
                                        <div class="flex items-center gap-4">
                                            ...
                                            <div>
                                                <span title="{{ $post->user->name() }}"
                                                    class="block max-w-[150px] overflow-hidden text-ellipsis whitespace-nowrap font-semibold text-gray-700 dark:text-gray-200">{{ $post->user->name() }}</span>
                                                <span
                                ...
                                <div>
                                    <article class="m-auto leading-6 text-gray-700 dark:text-gray-200">
                                    ...
                                    @if ($post->tags->count())
                                        <div class="pt-10">
                                            <span class="mb-3 block font-semibold text-gray-700 dark:text-gray-200">Tags</span>
                                            <div class="space-x-2 space-y-1">
                                                @foreach ($post->tags as $tag)
                                                    <a href="{{ route('filamentblog.tag.post', ['tag' => $tag->slug]) }}"
                                                        class="rounded-full border border-slate-300 px-3 py-1 text-sm font-medium font-medium text-gray-700 dark:text-gray-200 text-slate-600 hover:bg-slate-100">
                                                        {{ $tag->name }}
                                                    </a>
                                                @endforeach
                                            </div>
                ...
                <div>
                    <div>
                        <div class="relative mb-6 flex items-center gap-x-8">
                            <h2 class="whitespace-nowrap text-xl font-semibold text-gray-700 dark:text-gray-200">
                                <span
                        ...
                        <div class="grid md:grid-cols-3 sm:grid-cols-1 gap-x-12 gap-y-10">
                            ...
                            @empty
                                <div class="col-span-3">
                                    <p class="text-center text-xl font-semibold text-gray-300">No related posts found.
                                    </p>
                                </div>
                            @endforelse
                        </div>
