<nav class="sticky z-20 top-0 border-gray-200 bg-gray-50 dark:bg-gray-900 dark:border-gray-700 shadow">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">

        <a href="https://dispora.kalselprov.go.id" class="flex items-center space-x-3 rtl:space-x-reverse">
            <img src="{{ asset('storage/images/logo-kalsel.png') }}" class="h-10"
                alt="Dispora Logo" />
            <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">DISPORA</span>
        </a>
