<nav id="navbar" class="sticky z-20 top-0 top-0 left-0 w-full bg-white bg-opacity-50 backdrop-blur-md shadow-none border-b border-transparent dark:bg-gray-900/70">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <a href="https://dispora.kalselprov.go.id" class="flex items-center space-x-3 rtl:space-x-reverse antialiased">
            <img src="{{ asset('storage/images/logo-kalsel.png') }}" class="h-10 transition-transform transform"
                alt="Dispora Logo" />
            <span id="website-title" class="self-center text-2xl font-bold whitespace-nowrap dark:text-white transition-transform transform">DISPORA</span>
        </a>
